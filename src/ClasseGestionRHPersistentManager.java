...
public class ClasseGestionRHPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "ClasseGestionRH";
	...
	private ClasseGestionRHPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new ClasseGestionRHPersistentManager();
		}
