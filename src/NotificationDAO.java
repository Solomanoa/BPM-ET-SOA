...
public class NotificationDAO {
	...
	public static Notification loadNotificationByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Notification) session.load(Notification.class, Integer.valueOf(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Notification getNotificationByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Notification) session.get(Notification.class, Integer.valueOf(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Notification loadNotificationByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Notification) session.load(Notification.class, Integer.valueOf(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Notification getNotificationByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Notification) session.get(Notification.class, Integer.valueOf(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static boolean save(Notification notification) throws PersistentException {
		try {
			ClasseGestionRHPersistentManager.instance().saveObject(notification);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(Notification notification) throws PersistentException {
		try {
			ClasseGestionRHPersistentManager.instance().deleteObject(notification);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(Notification notification)throws PersistentException {
		try {
			if (notification.getConsultantRH() != null) {
				notification.getConsultantRH().setNotification(null);
			}
			
			if (notification.getCompagniesuurance() != null) {
				notification.getCompagniesuurance().setNotification(null);
			}
			
			if (notification.getEmploye() != null) {
				notification.getEmploye().setNotification(null);
			}
	...
	public static boolean refresh(Notification notification) throws PersistentException {
		try {
			ClasseGestionRHPersistentManager.instance().getSession().refresh(notification);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(Notification notification) throws PersistentException {
		try {
			ClasseGestionRHPersistentManager.instance().getSession().evict(notification);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
